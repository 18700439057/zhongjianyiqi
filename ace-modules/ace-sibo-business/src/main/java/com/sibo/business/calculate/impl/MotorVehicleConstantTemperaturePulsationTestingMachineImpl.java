 ...
 * 机动车恒温脉动试验机
 */
public class MotorVehicleConstantTemperaturePulsationTestingMachineImpl implements AnalysisFactory {
    @Override
    ...
    public Map exportExcel(List<VSourceRecord> sourceList, Map<String, Object> resultMap) throws Exception {
        ...
        resultMap.put("filePath", "机动车恒温脉动试验机.xlsx");
        return resultMap;
    }

    @Override
    public AnalysisFactory getAnalysis() {
        return new MotorVehicleConstantTemperaturePulsationTestingMachineImpl();
    }
}

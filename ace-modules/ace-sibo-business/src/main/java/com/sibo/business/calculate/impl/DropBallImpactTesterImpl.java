 ...
 * 落球冲击试验台
 */
public class DropBallImpactTesterImpl  implements AnalysisFactory {
    @Override
    ...
    public Map<String, Object> exportExcel(List<VSourceRecord> sourceList, Map<String, Object> datas) throws Exception {
        ...
        datas.put("filePath", "落球冲击试验台.xlsx");
        return datas;
    }

    @Override
    public AnalysisFactory getAnalysis() {
        return new DropBallImpactTesterImpl();
    }
}

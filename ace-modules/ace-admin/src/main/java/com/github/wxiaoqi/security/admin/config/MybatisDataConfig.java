...
public class MybatisDataConfig {
    ...
    public void init(){
        ...
        sqlSessionFactory.getConfiguration().addInterceptor(new MybatisDataInterceptor(userDepartDataService,"com.github.wxiaoqi.security.admin.mapper.UserMapper.selectOne",
                "com.github.wxiaoqi.security.admin.mapper.UserMapper.selectByPrimaryKey",
                "com.github.wxiaoqi.security.admin.mapper.DepartMapper.selectByPrimaryKey",
                "com.github.wxiaoqi.security.admin.mapper.DepartMapper.selectAll",
                "com.github.wxiaoqi.security.admin.mapper.UserMapper.selectAll",
                "com.github.wxiaoqi.security.admin.mapper.GroupMapper.selectGropByUserId",
                "com.github.wxiaoqi.security.admin.mapper.DepartMapper.selectDepartUsers"));
    }
}

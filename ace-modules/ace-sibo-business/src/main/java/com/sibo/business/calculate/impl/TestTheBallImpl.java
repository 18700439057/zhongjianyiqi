 ...
 * 试验球
 */
public class TestTheBallImpl implements AnalysisFactory {
    @Override
...
//        String tmpFile = "classpath:static/试验球.xls";
//        File file = ResourceUtils.getFile(tmpFile);
        resultMap.put("filePath","试验球.xls");
        return resultMap;
    }

    @Override
    public AnalysisFactory getAnalysis() {
        return new TestTheBallImpl();
    }
}

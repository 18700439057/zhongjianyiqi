 ...
 * 温控器寿命试验仪
 */
public class ThermostatLifeTesterImpl  implements AnalysisFactory {
    @Override
    ...
    public Map<String, Object> exportExcel(List<VSourceRecord> sourceList,Map<String, Object> datas) throws Exception {
        ...
        datas.put("filePath","温控器寿命试验仪.xlsx");
        return datas;
    }

    @Override
    public AnalysisFactory getAnalysis() {
        return new ThermostatLifeTesterImpl();
    }
}
